...
import { ArrowRight, Info, CheckCircle2, AlertCircle, Trophy, Heart, Zap, Brain, Target } from 'lucide-react';
    ...
    return (
        <section className="max-w-5xl mx-auto px-4 mt-24 pb-24">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                {/* Diagnostic Widget */}
                <div className="bg-white rounded-[2.5rem] p-8 shadow-2xl border border-gray-100 relative overflow-hidden flex flex-col justify-center min-h-[500px]">
