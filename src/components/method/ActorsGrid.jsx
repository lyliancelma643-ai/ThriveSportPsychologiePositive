        ...
        <section id="acteurs" ref={sectionRef} className="scroll-mt-32 py-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                {ACTORS.map((actor, index) => (
                    <div
                        key={actor.key}
                        className={`bg-white border border-gray-100 rounded-[1.5rem] p-7 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-700 ease-out flex flex-col transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}
